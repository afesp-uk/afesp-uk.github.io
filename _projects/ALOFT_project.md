...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/aloft_img.png" title="Aligning coarse- and high-resolution simulations" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Representation of same mesoscale convective system on a km-scale grid (left) and a coarser grid (right): aligning the two models lets features be compared like for like. Image: Alex Gerst, ISS
</div>
